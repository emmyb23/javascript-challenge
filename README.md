...
Below are the instructions for this javascript challenge.  I chose to use the starter html code but added some of my own styling and flair.  I attempted both levels (bonus= level #2).
